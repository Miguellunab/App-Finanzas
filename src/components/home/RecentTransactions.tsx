    ...
    <div className="mx-4 mt-4 rounded-2xl overflow-hidden" style={{ background: '#111118', border: '1px solid #1e1e28' }}>
      ...
      <div className="flex flex-col">
        {transactions.map((tx, i) => {
          ...
          const kind = tx.expenseKind === 'fixed' ? 'Fijo' : tx.expenseKind === 'variable' ? 'Variable' : tx.expenseKind === 'mismatch' ? 'Ajuste por faltante' : tx.expenseKind === 'surplus' ? 'Ajuste por sobrante' : null;
          return (
