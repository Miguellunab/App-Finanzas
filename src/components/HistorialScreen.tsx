                ...
                {txs.map((tx, i) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="opacity-100 md:opacity-0 md:group-hover:opacity-100 ml-1 p-2 rounded-lg transition-opacity"
                      style={{ color: '#f43f5e', background: 'rgba(244,63,94,0.1)', border: 'none', cursor: 'pointer' }}
                    >
